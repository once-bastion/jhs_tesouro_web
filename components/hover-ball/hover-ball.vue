<template>
	<view class="hover_ball_cell"
		...
		<view class="wave">
			<image @click="Jump" src="../../assets/images/minha/kefu.png" mode="widthFix"></image>
		</view>
	</view>
</template>
		...
		created() {
			...
			uni.getSystemInfo({
				success(res) {
					...
					_this.top = res.windowHeight -80;
					_this.left = _this.modile.safeArea.left + 360;
					_this.diameter = _this.modile.screenHeight / 18;
				}
			})
...
<style lang="less" scoped>
	.hover_ball_cell {
		...
		overflow: hidden;
		border-radius: 50%;
		// border: 4upx solid rgb(230, 196, 5);
		background: #ffffff;
